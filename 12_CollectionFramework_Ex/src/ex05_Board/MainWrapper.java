...
public class MainWrapper {
  ...
  public static void main(String[] args) {
    ...
    for(int i = 0, length = boardList.size(); i < length; i++) {
      for(String key : boardList.get(i).keySet()) {
        System.out.println(key + ": " + boardList.get(i).get(key));
      }
    }
  }
}
