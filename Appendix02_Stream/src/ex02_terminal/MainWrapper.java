...
//    System.out.println("합계: " + iStream.sum());      -> 1, 2, 3, 4, 5       
//    System.out.println("평균: " + iStream.average());  ->    안나옴    ->  위처럼 선언후 사용하게되면 한번 뽑았으므로 재사용 불가능
    ...
    System.out.println("최대: " + IntStream.range(1, 6).min().getAsInt());
  }
