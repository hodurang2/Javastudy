...
public class Library {
   ...
   */
  private void modifyBook() throws InputMismatchException {
  ...
  private void queryAllBook() throws RuntimeException {
    ...
    if(books.isEmpty()) {
      throw new RuntimeException("책이 한 권도 없습니다.");
    }
  ...
  public void manage() {
    ...
    // 사용자가 종료 명령을 내릴 때 까지 프로그램은 종료되지 않는다.
    while(true) {
      ...
      try {
        ...
        case "0": System.out.println("도서 관리 프로그램을 종료합니다."); return;
