...
//    ex01();  -> OracleDriver 클래스를 Load
//    ex02();  -> Connection 객체 생성하는법
//    ex03();  -> 별도의 프로퍼티 파일이 있을때 읽는법
    Connection con = getConnection();     // OracleDriver먼저 실행후 프로퍼티파일들을 읽고 거기에있는 요소들로 Connection객체 생성
