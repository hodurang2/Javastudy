...
public class ContactServiceImpl implements ContactService {
  ...
  public int insert(Map<String, Object> map) {
    System.out.println("삽입 Service::" + map);
    // Map -> ContactDto
  ...
  public int update(Map<String, Object> map) {
    System.out.println("수정 Service::" + map);
  ...
  public int delete(Map<String, Object> map) {
    System.out.println("삭제 Service::" + map);
  ...
  public List<ContactDto> selectList() {
    System.out.println("전제 조회 Service::");
    // 실행 + 결과반환
  ...
  public ContactDto selectContactByNo(Map<String, Object> map) {
    System.out.println("개별 Service::" + map);
    // Map에서 contact_no 추출
    int contact_no = Integer.parseInt((String)map.get("contact_no"));
    // 실행 + 결과반환
