...
//                    // 개설지점: 국민은행가산지점(02-111-1111)
    ...
    // 새로운 객체 선언 & 생성
    Bank bank1 = new Bank();
    bank1.setBankName("우리은행");
    bank1.setBankNo("02-222-2222");
    ...
    System.out.println("개설지점: " + member1.getAcc().getBank().getBankName());
    System.out.println("지점연락처: " + member1.getBank().getBankNo());
    
    // 새로운 객체 선언 & 생성
    Bank bank2 = new Bank();
    bank2.setBankName("국민은행");
    bank2.setBankNo("02-333-3333");
    ...
    System.out.println("개설지점: " + member2.getAcc().getBank().getBankName());
    System.out.println("지점연락처: " + member2.getBank().getBankNo());
