...
public class MainWrapper1 {
  ...
  public static void ex05(int[] arr) { // 배열 인수는 파라미터 int[] arr로 받는다.
    System.out.println("ex05 : " + Arrays.toString(arr));
  }
  
  public static void ex04(String name, int age) {  // 문자열 인수는 파라미터 String name으로 받고 정수형 인수는 int age로 받는다.
    System.out.println("ex04_name : " + name);
    System.out.println("ex04_age : " + age);
  }
  
  public static void ex03(double a, double b) {  // 인수가 실수 2개이면 파라미터 double a, double b를 선언한다.
    System.out.println("exo3_a : " + a);
    System.out.println("exo3_b : " + b);
