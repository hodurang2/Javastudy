...
public class MainWrapper {
  ...
  public static void ex01() {
     ...
     *      1) 프로토콜     : 통신규약, https(secure + http : 보안처리된 하이퍼텍스트 전송 프로토콜)
     *      2) 호스트       : 서버이름
     *      3) URLMapping   : 서버경로
     *      4) 파라미터     : 서버로 보내는 데이터
     */
    ...
    // URL 정보 분석하기
    String apiURL = "https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=폭염";
    ...
    try {
      ...
      System.out.println("apuURL 형식 오류");
    }
...
//    String spec = "https://www.naver.com/";
    ...
    try {
      ...
      // URL 객체 생성 (MalformedURLExcepton 발생)
      url = new URL(spec);
  ...
  public static void ex03() {
    ...
    // 입력스트림 선언 (네이버 배너 읽는 스트림)
    BufferedInputStream bin = null;
    
    // 출력스트림 선언 (읽어온 배너를 dir에 file로 출력하는 스트림)
  ...
  public static void ex04() {
    ...
    try {
      ...
      // 원본 데이터
      String originData = "홍길동 tom 123 ~!@#$%^&*()_+=-";
