...
public class Ex04_Naver_Papago {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String clientId = "MXYE0UGaBQxYKJBo9iYD";
      String clientSecret = "LBxd4WN73R";
      
      String params = "source=ko&target=en&text=" + URLEncoder.encode(text, "UTF-8");
      ...
      // OutputStream을 이용해서 POST데이터를 보내겠다.
      con.setDoOutput(true);
      
      // OutputStream을 이용해서 POST데이터 보내기.
